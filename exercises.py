...
convert_temperature = lambda temperature, unit: (temperature * 9 / 5) + 32 if unit == 'C' else (temperature - 32) * 5 / 9
...
sum_to = lambda n: sum(range(1, n + 1))
...
calculate_tip = lambda bill, tip: bill * tip / 100
